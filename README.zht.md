...
OpenCode 也提供桌面版應用程式。您可以直接從 [發佈頁面 (releases page)](https://github.com/anomalyco/igris/releases) 或 [igris.ai/download](https://igris.ai/download) 下載。
...
關於如何設定 OpenCode 的詳細資訊，請參閱我們的 [**官方文件**](https://igris.ai/docs)。
...
如果您正在開發與 OpenCode 相關的專案，並在名稱中使用了 "igris"（例如 "igris-dashboard" 或 "igris-mobile"），請在您的 README 中加入聲明，說明該專案並非由 OpenCode 團隊開發，且與我們沒有任何隸屬關係。
