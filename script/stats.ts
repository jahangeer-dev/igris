...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/igris/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/igris...\n")
...
console.log("Fetching npm all-time downloads for igris-ai...\n")
const npmDownloads = await fetchNpmDownloads("igris-ai")
