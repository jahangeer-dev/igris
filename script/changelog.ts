...
Generates UPCOMING_CHANGELOG.md by running the igris changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for igris run (default: low)
      --quiet            Suppress igris command output unless it fails
