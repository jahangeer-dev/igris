...
const tableBucketName = `igris-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `igris-${$app.stage}-lake-ingest`,
    destination: "iceberg",
