...
- Keep product naming consistent: `OpenCode` in prose, `igris` only for exact technical identifiers
...
- Avoid changing `igris` to `OpenCode` inside commands, URLs, package names, or code literals
