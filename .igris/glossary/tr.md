...
- PR #15835: https://github.com/anomalyco/igris/pull/15835

## Do Not Translate (Locale Additions)

- `Igris` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `igris` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Igris` in prose, `igris` only for exact technical identifiers
...
- Avoid changing `igris` to `Igris` inside commands, URLs, package names, or code literals
