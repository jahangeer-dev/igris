...
Use this folder for locale-specific translation guidance that supplements `.igris/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/igris/pull/12345

## Do Not Translate (Locale Additions)

- `Igris` (preserve casing)
