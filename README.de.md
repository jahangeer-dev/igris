...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/anomalyco/igris/releases) oder [igris.ai/download](https://igris.ai/download) herunter.
...
Mehr Infos zur Konfiguration von OpenCode findest du in unseren [**Docs**](https://igris.ai/docs).
...
Wenn du an einem Projekt arbeitest, das mit OpenCode zusammenhängt und "igris" als Teil seines Namens verwendet (z.B. "igris-dashboard" oder "igris-mobile"), füge bitte einen Hinweis in deine README ein, dass es nicht vom OpenCode-Team gebaut wird und nicht in irgendeiner Weise mit uns verbunden ist.
