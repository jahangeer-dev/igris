...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/anomalyco/igris/releases) oppure da [igris.ai/download](https://igris.ai/download).
...
Per maggiori informazioni su come configurare OpenCode, [**consulta la nostra documentazione**](https://igris.ai/docs).
...
Se stai lavorando a un progetto correlato a OpenCode e che utilizza “igris” come parte del nome (ad esempio “igris-dashboard” o “igris-mobile”), aggiungi una nota nel tuo README per chiarire che non è sviluppato dal team OpenCode e che non è affiliato in alcun modo con noi.
