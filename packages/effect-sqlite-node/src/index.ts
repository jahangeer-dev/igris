...
export const TypeId: TypeId = "~@igris-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@igris-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@igris-ai/effect-sqlite-node/NodeSqliteClient")
