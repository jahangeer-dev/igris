...
Schema-first LLM core for igris. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@igris-ai/llm"
import { OpenAI } from "@igris-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@igris-ai/llm/providers"
