import { OpenCode } from "@igris-ai/client/effect"
...
export const create = Effect.fn("OpenCode.create")(function* () {
  ...
  const client = yield* OpenCode.make({ baseUrl: "http://igris.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@igris-ai/sdk-next/OpenCode") {}
