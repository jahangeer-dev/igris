import { Igris } from "@igris-ai/client/effect"
...
import { createEmbeddedRoutes } from "@igris-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Igris.create")(function* () {
  ...
  const client = yield* Igris.make({ baseUrl: "http://igris.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@igris-ai/sdk-next/Igris") {}
