...
export const dict = {
  ...
  "dialog.provider.igris.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.igris.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.igrisGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Igris",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Igris zu nutzen.",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.igrisZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.igrisZen.visit.link": "igris.ai/zen",
  "provider.connect.igrisZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Igris zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Igris zu nutzen.",
  ...
  "dialog.plugins.empty": "In igris.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Igris-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.igris": "Igris",
  ...
  "wsl.onboarding.checkingIgris": "Igris wird geprüft...",
  "wsl.onboarding.checkingIgrisIn": "Igris in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingIgris": "Igris wird aktualisiert...",
  "wsl.onboarding.updatingIgrisIn": "Igris in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateIgrisIn": "Aktualisieren Sie Igris in {{distro}}.",
  "wsl.onboarding.updateIgris": "Igris aktualisieren",
  "wsl.onboarding.igrisReadyIn": "Igris ist in {{distro}} bereit.",
  "wsl.onboarding.igrisReady": "Igris ist bereit.",
  "wsl.onboarding.installIgrisIn": "Installieren Sie Igris in {{distro}}.",
  "wsl.onboarding.installIgris": "Igris installieren",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Igris einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Igris konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Igris erneut.",
  ...
  "toast.update.description": "Eine neue Version von Igris ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Igris-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (igris.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Igris unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Igris enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Igris Desktop",
  ...
  "settings.desktop.wsl.description": "Igris-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Igris ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Igris auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Igris dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Igris anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Igris automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Igris.",
