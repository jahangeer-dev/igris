export const dict = {
  ...
  "dialog.provider.igris.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.igris.tagline": "Modèles optimisés et fiables",
  "dialog.provider.igrisGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Igris",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Igris.",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.igrisZen.visit.prefix": "Visitez ",
  "provider.connect.igrisZen.visit.link": "igris.ai/zen",
  "provider.connect.igrisZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Igris.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Igris.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans igris.json",
  ...
  "dialog.server.description": "Changez le serveur Igris auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingIgris": "Vérification d'Igris...",
  "wsl.onboarding.checkingIgrisIn": "Vérification d'Igris dans {{distro}}...",
  "wsl.onboarding.updatingIgris": "Mise à jour d'Igris...",
  "wsl.onboarding.updatingIgrisIn": "Mise à jour d'Igris dans {{distro}}...",
  "wsl.onboarding.updateIgrisIn": "Mettez à jour Igris dans {{distro}}.",
  "wsl.onboarding.updateIgris": "Mettre à jour Igris",
  "wsl.onboarding.igrisReadyIn": "Igris est prêt dans {{distro}}.",
  "wsl.onboarding.igrisReady": "Igris est prêt.",
  "wsl.onboarding.installIgrisIn": "Installez Igris dans {{distro}}.",
  "wsl.onboarding.installIgris": "Installer Igris",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Igris puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Igris n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Igris.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Igris ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Igris",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (igris.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Igris ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Igris inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Igris dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Igris",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Igris sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Igris suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Igris.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Igris",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Igris.",
