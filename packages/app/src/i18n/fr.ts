export const dict = {
  ...
  "wsl.onboarding.igrisReadyIn": "OpenCode est prêt dans {{distro}}.",
  "wsl.onboarding.igrisReady": "OpenCode est prêt.",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "OpenCode non installé",
