...
export const dict = {
  ...
  "provider.connect.igrisZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "wsl.onboarding.igrisReadyIn": "{{distro}} 中的 OpenCode 已就緒。",
  "wsl.onboarding.igrisReady": "OpenCode 已就緒。",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "未安裝 OpenCode",
