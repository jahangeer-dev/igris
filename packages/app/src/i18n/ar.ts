export const dict = {
  ...
  "dialog.provider.igris.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.igris.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.igrisGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Igris",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Igris.",
  ...
  "provider.connect.igrisZen.line1":
    "يمنحك Igris Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.igrisZen.visit.prefix": "قم بزيارة ",
  "provider.connect.igrisZen.visit.link": "igris.ai/zen",
  "provider.connect.igrisZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Igris.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Igris.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في igris.json",
  ...
  "dialog.server.description": "تبديل خادم Igris الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingIgris": "جارٍ التحقق من Igris...",
  "wsl.onboarding.checkingIgrisIn": "جارٍ التحقق من Igris في {{distro}}...",
  "wsl.onboarding.updatingIgris": "جارٍ تحديث Igris...",
  "wsl.onboarding.updatingIgrisIn": "جارٍ تحديث Igris في {{distro}}...",
  "wsl.onboarding.updateIgrisIn": "حدّث Igris في {{distro}}.",
  "wsl.onboarding.updateIgris": "تحديث Igris",
  "wsl.onboarding.igrisReadyIn": "Igris جاهز في {{distro}}.",
  "wsl.onboarding.igrisReady": "Igris جاهز.",
  "wsl.onboarding.installIgrisIn": "ثبّت Igris في {{distro}}.",
  "wsl.onboarding.installIgris": "تثبيت Igris",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Igris من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Igris التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Igris.",
  ...
  "toast.update.description": "نسخة جديدة من Igris ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Igris",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (igris.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Igris لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Igris نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Igris داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Igris",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Igris على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Igris يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Igris.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Igris",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Igris.",
