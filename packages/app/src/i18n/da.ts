export const dict = {
  ...
  "dialog.provider.igris.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.igris.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.igrisGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Igris",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Igris.",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.igrisZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.igrisZen.visit.prefix": "Besøg ",
  "provider.connect.igrisZen.visit.link": "igris.ai/zen",
  "provider.connect.igrisZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Igris.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Igris.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i igris.json",
  ...
  "dialog.server.description": "Skift hvilken Igris-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingIgris": "Tjekker Igris...",
  "wsl.onboarding.checkingIgrisIn": "Tjekker Igris i {{distro}}...",
  "wsl.onboarding.updatingIgris": "Opdaterer Igris...",
  "wsl.onboarding.updatingIgrisIn": "Opdaterer Igris i {{distro}}...",
  "wsl.onboarding.updateIgrisIn": "Opdater Igris i {{distro}}.",
  "wsl.onboarding.updateIgris": "Opdater Igris",
  "wsl.onboarding.igrisReadyIn": "Igris er klar i {{distro}}.",
  "wsl.onboarding.igrisReady": "Igris er klar.",
  "wsl.onboarding.installIgrisIn": "Installer Igris i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Igris kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Igris kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Igris igen.",
  ...
  "toast.update.description": "En ny version af Igris ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Igris-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (igris.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Igris understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Igris inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Igris-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Igris",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Igris ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Igris følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Igris er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Igris starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Igris.",
