export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Igris",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Igris-u.",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Igris-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Igris-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Igris server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingIgris": "Provjera Igris...",
  "wsl.onboarding.checkingIgrisIn": "Provjera Igris u distribuciji {{distro}}...",
  "wsl.onboarding.updatingIgris": "Ažuriranje Igris...",
  "wsl.onboarding.updatingIgrisIn": "Ažuriranje Igris u distribuciji {{distro}}...",
  "wsl.onboarding.updateIgrisIn": "Ažuriraj Igris u distribuciji {{distro}}.",
  "wsl.onboarding.updateIgris": "Ažuriraj Igris",
  "wsl.onboarding.igrisReadyIn": "Igris je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.igrisReady": "Igris je spreman.",
  "wsl.onboarding.installIgrisIn": "Instaliraj Igris u distribuciji {{distro}}.",
  "wsl.onboarding.installIgris": "Instaliraj Igris",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Igris mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Igris nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Igris.",
  ...
  "toast.update.description": "Nova verzija Igris-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Igris timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Igris još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Igris uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Igris server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Igris-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Igris izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Igris prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Igris-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Igris pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Igris-a.",
