...
export const dict = {
  ...
  "dialog.provider.igris.note": "使用 OpenCode Zen 或 API 密钥连接",
  ...
  "provider.connect.igrisZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "wsl.onboarding.igrisReadyIn": "{{distro}} 中的 OpenCode 已就绪。",
  "wsl.onboarding.igrisReady": "OpenCode 已就绪。",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "未安装 OpenCode",
