export const dict = {
  ...
  "wsl.onboarding.igrisReadyIn": "OpenCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.igrisReady": "OpenCode jest gotowy.",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "OpenCode nie jest zainstalowany",
