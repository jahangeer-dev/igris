export const dict = {
  ...
  "dialog.provider.igris.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.igris.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.igrisGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Igris",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Igris.",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.igrisZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.igrisZen.visit.prefix": "Odwiedź ",
  "provider.connect.igrisZen.visit.link": "igris.ai/zen",
  "provider.connect.igrisZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Igris.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Igris.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w igris.json",
  ...
  "dialog.server.description": "Przełącz serwer Igris, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingIgris": "Sprawdzanie Igris...",
  "wsl.onboarding.checkingIgrisIn": "Sprawdzanie Igris w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingIgris": "Aktualizowanie Igris...",
  "wsl.onboarding.updatingIgrisIn": "Aktualizowanie Igris w dystrybucji {{distro}}...",
  "wsl.onboarding.updateIgrisIn": "Zaktualizuj Igris w dystrybucji {{distro}}.",
  "wsl.onboarding.updateIgris": "Zaktualizuj Igris",
  "wsl.onboarding.igrisReadyIn": "Igris jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.igrisReady": "Igris jest gotowy.",
  "wsl.onboarding.installIgrisIn": "Zainstaluj Igris w dystrybucji {{distro}}.",
  "wsl.onboarding.installIgris": "Zainstaluj Igris",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Igris będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Igris nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Igris.",
  ...
  "toast.update.description": "Nowa wersja Igris ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Igris",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (igris.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Igris nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Igris zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Igris wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Igris",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Igris na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Igris ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Igris.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Igris",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Igris.",
