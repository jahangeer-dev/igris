export const dict = {
  ...
  "dialog.provider.igris.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.igris.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.igrisGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Igris",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Igris.",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.igrisZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.igrisZen.visit.prefix": "Visite ",
  "provider.connect.igrisZen.visit.link": "igris.ai/zen",
  "provider.connect.igrisZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Igris.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Igris.",
  ...
  "dialog.plugins.empty": "Plugins configurados em igris.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Igris este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingIgris": "Verificando o Igris...",
  "wsl.onboarding.checkingIgrisIn": "Verificando o Igris em {{distro}}...",
  "wsl.onboarding.updatingIgris": "Atualizando o Igris...",
  "wsl.onboarding.updatingIgrisIn": "Atualizando o Igris em {{distro}}...",
  "wsl.onboarding.updateIgrisIn": "Atualize o Igris em {{distro}}.",
  "wsl.onboarding.updateIgris": "Atualizar o Igris",
  "wsl.onboarding.igrisReadyIn": "O Igris está pronto em {{distro}}.",
  "wsl.onboarding.igrisReady": "O Igris está pronto.",
  "wsl.onboarding.installIgrisIn": "Instale o Igris em {{distro}}.",
  "wsl.onboarding.installIgris": "Instalar o Igris",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Igris possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Igris não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Igris novamente.",
  ...
  "toast.update.description": "Uma nova versão do Igris ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Igris",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (igris.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Igris ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Igris inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Igris dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Igris",
  ...
  "settings.general.row.appearance.description": "Personalize como o Igris aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Igris segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Igris é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Igris iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Igris.",
