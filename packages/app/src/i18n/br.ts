export const dict = {
  ...
  "wsl.onboarding.igrisReadyIn": "O OpenCode está pronto em {{distro}}.",
  "wsl.onboarding.igrisReady": "O OpenCode está pronto.",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "OpenCode não instalado",
