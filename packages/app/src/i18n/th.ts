export const dict = {
  ...
  "wsl.onboarding.igrisReadyIn": "OpenCode พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.igrisReady": "OpenCode พร้อมใช้งานแล้ว.",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "ยังไม่ได้ติดตั้ง OpenCode",
