export const dict = {
  ...
  "wsl.onboarding.igrisReadyIn": "{{distro}}内のOpenCodeの準備ができました。",
  "wsl.onboarding.igrisReady": "OpenCodeの準備ができました。",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "OpenCodeがインストールされていません",
