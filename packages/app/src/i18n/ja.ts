export const dict = {
  ...
  "dialog.provider.igris.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.igris.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.igrisGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Igrisが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Igrisで{{provider}}モデルを使用します。",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.igrisZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.igrisZen.visit.prefix": " ",
  "provider.connect.igrisZen.visit.link": "igris.ai/zen",
  "provider.connect.igrisZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してIgrisで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Igrisで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "igris.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するIgrisサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingIgris": "Igrisを確認中...",
  "wsl.onboarding.checkingIgrisIn": "{{distro}}内のIgrisを確認中...",
  "wsl.onboarding.updatingIgris": "Igrisを更新中...",
  "wsl.onboarding.updatingIgrisIn": "{{distro}}内のIgrisを更新中...",
  "wsl.onboarding.updateIgrisIn": "{{distro}}内のIgrisを更新してください。",
  "wsl.onboarding.updateIgris": "Igrisを更新",
  "wsl.onboarding.igrisReadyIn": "{{distro}}内のIgrisの準備ができました。",
  "wsl.onboarding.igrisReady": "Igrisの準備ができました。",
  "wsl.onboarding.installIgrisIn": "{{distro}}にIgrisをインストールしてください。",
  "wsl.onboarding.installIgris": "Igrisをインストール",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igrisがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "IgrisでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Igrisをもう一度開いてください。",
  ...
  "toast.update.description": "Igrisの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをIgrisチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (igris.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: IgrisはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Igrisには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でIgrisサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Igrisの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのIgrisの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Igrisがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Igrisのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Igris の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Igris は最新バージョンです。",
