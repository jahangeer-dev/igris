export const dict = {
  ...
  "dialog.provider.igris.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.igris.tagline": "Reliable optimized models",
  "dialog.provider.igrisGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Igris",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Igris.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.igrisZen.line1":
    "Igris Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.igrisZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.igrisZen.visit.prefix": "Visit ",
  "provider.connect.igrisZen.visit.link": "igris.ai/zen",
  "provider.connect.igrisZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Igris.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Igris.",
  ...
  "dialog.plugins.empty": "Plugins configured in igris.json",
  ...
  "dialog.server.description": "Switch which Igris server this app connects to.",
  ...
  "wsl.onboarding.checkingIgris": "Checking Igris...",
  "wsl.onboarding.checkingIgrisIn": "Checking Igris in {{distro}}...",
  "wsl.onboarding.updatingIgris": "Updating Igris...",
  "wsl.onboarding.updatingIgrisIn": "Updating Igris in {{distro}}...",
  "wsl.onboarding.updateIgrisIn": "Update Igris in {{distro}}.",
  "wsl.onboarding.updateIgris": "Update Igris",
  "wsl.onboarding.igrisReadyIn": "Igris is ready in {{distro}}.",
  "wsl.onboarding.igrisReady": "Igris is ready.",
  "wsl.onboarding.installIgrisIn": "Install Igris in {{distro}}.",
  "wsl.onboarding.installIgris": "Install Igris",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Igris can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Igris could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Igris.",
  ...
  "toast.update.description": "A new version of Igris ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Igris team",
  ...
  "error.chain.checkConfig": "Check your config (igris.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Igris does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Igris includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Igris server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Igris",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Igris looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Igris follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Igris is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Igris launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Igris.",
