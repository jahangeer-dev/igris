...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Igris",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Igris.",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Igris.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Igris.",
  ...
  "dialog.server.description": "Bytt hvilken Igris-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Igris ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Igris-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Igris ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Igris inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Igris-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Igris",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Igris ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Igris skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Igris er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Igris starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Igris.",
  ...
  "wsl.onboarding.checkingIgris": "Sjekker Igris...",
  "wsl.onboarding.checkingIgrisIn": "Sjekker Igris i {{distro}}...",
  "wsl.onboarding.updatingIgris": "Oppdaterer Igris...",
  "wsl.onboarding.updatingIgrisIn": "Oppdaterer Igris i {{distro}}...",
  "wsl.onboarding.updateIgrisIn": "Oppdater Igris i {{distro}}.",
  "wsl.onboarding.updateIgris": "Oppdater Igris",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Igris kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Igris kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Igris på nytt.",
