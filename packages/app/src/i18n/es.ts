export const dict = {
  ...
  "dialog.provider.igris.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.igris.tagline": "Modelos optimizados y fiables",
  "dialog.provider.igrisGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Igris",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Igris.",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.igrisZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.igrisZen.visit.prefix": "Visita ",
  "provider.connect.igrisZen.visit.link": "igris.ai/zen",
  "provider.connect.igrisZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Igris.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Igris.",
  ...
  "dialog.plugins.empty": "Plugins configurados en igris.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Igris se conecta esta app.",
  ...
  "wsl.onboarding.checkingIgris": "Comprobando Igris...",
  "wsl.onboarding.checkingIgrisIn": "Comprobando Igris en {{distro}}...",
  "wsl.onboarding.updatingIgris": "Actualizando Igris...",
  "wsl.onboarding.updatingIgrisIn": "Actualizando Igris en {{distro}}...",
  "wsl.onboarding.updateIgrisIn": "Actualiza Igris en {{distro}}.",
  "wsl.onboarding.updateIgris": "Actualizar Igris",
  "wsl.onboarding.igrisReadyIn": "Igris está listo en {{distro}}.",
  "wsl.onboarding.igrisReady": "Igris está listo.",
  "wsl.onboarding.installIgrisIn": "Instala Igris en {{distro}}.",
  "wsl.onboarding.installIgris": "Instalar Igris",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Igris pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Igris no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Igris.",
  ...
  "toast.update.description": "Una nueva versión de Igris ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Igris",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (igris.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Igris no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Igris incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Igris dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Igris",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Igris en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Igris sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Igris.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Igris",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Igris.",
