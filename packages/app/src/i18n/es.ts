export const dict = {
  ...
  "wsl.onboarding.igrisReadyIn": "OpenCode está listo en {{distro}}.",
  "wsl.onboarding.igrisReady": "OpenCode está listo.",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "OpenCode no está instalado",
