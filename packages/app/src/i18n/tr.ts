...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Igris tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Igris'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.igrisZen.line1":
    "Igris Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Igris'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Igris'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Igris sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingIgris": "Igris kontrol ediliyor...",
  "wsl.onboarding.checkingIgrisIn": "{{distro}} içinde Igris kontrol ediliyor...",
  "wsl.onboarding.updatingIgris": "Igris güncelleniyor...",
  "wsl.onboarding.updatingIgrisIn": "{{distro}} içinde Igris güncelleniyor...",
  "wsl.onboarding.updateIgrisIn": "{{distro}} içindeki Igris'u güncelleyin.",
  "wsl.onboarding.updateIgris": "Igris'u güncelle",
  "wsl.onboarding.igrisReadyIn": "{{distro}} içinde Igris hazır.",
  "wsl.onboarding.igrisReady": "Igris hazır.",
  "wsl.onboarding.installIgrisIn": "Igris'u {{distro}} içine kurun.",
  "wsl.onboarding.installIgris": "Igris'u kur",
  ...
  "wsl.onboarding.distroStatus.igrisMissing": "Igris kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Igris'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Igris bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Igris'u tekrar açın.",
  ...
  "toast.update.description": "Igris'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Igris ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Igris henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Igris ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Igris Masaüstü",
  ...
  "settings.desktop.wsl.description": "Igris sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Igris'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Igris'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Igris'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Igris'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Igris başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Igris'un en son sürümünü kullanıyorsunuz.",
