...
const GLOBAL_STORAGE = "igris.global.dat"
const WINDOW_STORAGE = "igris.window"
const LOCAL_PREFIX = "igris."
...
function workspaceStorage(dir: string) {
  ...
  return `igris.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `igris.draft.${head}.${sum}.dat`
}
