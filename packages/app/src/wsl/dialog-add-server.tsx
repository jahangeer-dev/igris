...
import { showToast } from "@igris-ai/ui/toast"
...
import { LoaderV2 } from "@igris-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@igris-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-igris") {
      await run(() => api.installIgris(distro))
      return
    }
