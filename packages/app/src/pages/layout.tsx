...
import { Session } from "@igris-ai/sdk/v2/client"
...
import { toaster } from "@igris-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@igris-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://igris.ai/desktop-feedback")}
      renderPanel={() =>
