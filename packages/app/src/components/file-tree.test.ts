...
beforeAll(async () => {
  ...
  mock.module("@igris-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@igris-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@igris-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@igris-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
