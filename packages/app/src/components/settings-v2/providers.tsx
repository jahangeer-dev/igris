...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "igris", key: "dialog.provider.igris.note" },
  { match: (id: string) => id === "igris-go", key: "dialog.provider.igrisGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "igris" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "igris" || item.id === "igris-go"}>
