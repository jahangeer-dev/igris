...
- Effect plugins import `@igris-ai/plugin/v2/effect`, not `@igris-ai/core`.
- Public domain values use generated `@igris-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@igris-ai/plugin/v2/effect`.
