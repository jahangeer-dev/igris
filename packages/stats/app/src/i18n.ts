...
const en = {
  "app.title": "AI Model Usage Rankings | Igris Data",
  "app.description":
    "Explore Igris Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Igris Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Igris on GitHub",
  "header.github": "GitHub",
  "header.tryIgris": "Try Igris",
  ...
  "home.topModelsDescription": "Usage of models across Igris Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Igris Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Igris Data",
  "lab.description":
    "Compare {{lab}} models used in Igris Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Igris usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Igris",
  ...
  "lab.shareOfUsage": "{{share}} of recent Igris usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Igris Data",
  "model.description":
    "View {{model}} Igris Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Igris Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Igris Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Igris Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Igris Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Igris Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Igris Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Igris Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Igris Go token volume.",
