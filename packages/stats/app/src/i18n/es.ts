export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Igris Data",
  "app.description":
    "Explora el uso de Igris Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de Igris Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Igris en GitHub",
  "header.github": "GitHub",
  "header.tryIgris": "Probar Igris",
  ...
  "footer.homeAria": "Inicio de Igris",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Igris Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Igris Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Igris Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en Igris Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Igris.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Igris",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Igris",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Igris durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Igris Data",
  "model.description":
    "Consulta datos de uso de {{model}} en Igris Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Igris Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Igris Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Igris Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Igris Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Igris Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Igris Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Igris Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Igris Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Igris Go.",
  ...
  "model.geoDescription": "Tokens del modelo de Igris Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de Igris Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Igris Go.",
