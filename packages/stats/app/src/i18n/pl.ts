export const dict = {
  "app.title": "Rankingi użycia modeli AI | Igris Data",
  "app.description":
    "Przeglądaj użycie Igris Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Igris Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Igris na GitHub",
  "header.github": "GitHub",
  "header.tryIgris": "Wypróbuj Igris",
  ...
  "footer.homeAria": "Strona główna Igris",
  ...
  "home.topModelsDescription": "Użycie modeli w Igris Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Igris Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Igris Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Igris Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Igris.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Igris",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Igris",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Igris z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Igris Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Igris Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Igris Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Igris Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Igris Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Igris Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Igris Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Igris Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Igris Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Igris Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Igris Go.",
  ...
  "model.geoDescription": "Tokeny modelu Igris Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Igris Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Igris Go.",
