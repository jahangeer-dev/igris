import igrisWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/igris",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "igris:stats-theme"
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://igris.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://igris.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@igris.ai", label: i18n.t("footer.contact") },
    { href: "https://igris.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/igris", label: "X" },
