...
![OpenCode TUI con il tema igris](../../../assets/lander/screenshot.png)
...
- **Con Homebrew su macOS e Linux**
  ...
  > Ti consigliamo di usare il tap di OpenCode per avere le release piu aggiornate. La formula ufficiale `brew install igris` e mantenuta dal team Homebrew e viene aggiornata meno spesso.
...
Puoi anche scaricare il binario dalle [Releases](https://github.com/anomalyco/igris/releases).
...
1. Esegui il comando `/connect` nella TUI, seleziona igris e vai su [igris.ai/auth](https://igris.ai/auth).
...
Ecco un'[esempio di conversazione](https://igris.ai/s/4XP1fce5) con OpenCode.
