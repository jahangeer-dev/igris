...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `igris.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare igris nella tua organizzazione.
