...
OpenCode si integra con VS Code, Cursor o qualunque IDE che supporti un terminale. Basta eseguire `igris` nel terminale per iniziare.
...
3. Esegui `igris` - l'estensione si installa automaticamente
...
- Assicurati di eseguire `igris` nel terminale integrato.
