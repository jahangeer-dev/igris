...
- Config di progetto: `.igris/skills/<name>/SKILL.md`
- Config globale: `~/.config/igris/skills/<name>/SKILL.md`
...
Carica qualsiasi `skills/*/SKILL.md` corrispondente in `.igris/` e qualsiasi `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` corrispondente lungo il percorso.

Le definizioni globali vengono caricate anche da `~/.config/igris/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` e `~/.agents/skills/*/SKILL.md`.
...
Crea `.igris/skills/git-release/SKILL.md` cosi':
...
Controlla a quali skill gli agenti possono accedere usando permessi basati su pattern in `igris.json`:
...
**Per agenti integrati** (in `igris.json`):
