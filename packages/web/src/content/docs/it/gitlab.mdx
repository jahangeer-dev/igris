...
Qui usiamo un componente CI/CD creato dalla community per OpenCode — [nagyv/gitlab-igris](https://gitlab.com/nagyv/gitlab-igris).
...
Per altri input e casi d'uso, [consulta la documentazione](https://gitlab.com/explore/catalog/nagyv/gitlab-igris) di questo componente.
...
Menziona `@igris` in un commento e OpenCode eseguira' i task dentro la tua pipeline GitLab CI.
...
:::tip
Puoi configurare una frase trigger diversa da `@igris`.
:::
