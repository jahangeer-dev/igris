...
- Globale: `~/.config/igris/commands/`
- Per progetto: `.igris/commands/`
...
igris include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
