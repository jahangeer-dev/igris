...
Você pode adicionar comandos personalizados através da configuração do igris ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do igris:
...
- Global: `~/.config/igris/commands/`
- Por projeto: `.igris/commands/`
...
igris inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
