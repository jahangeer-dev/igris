...
O [model id](/docs/config/#models) na sua configuração do OpenCode usa o formato `igris/<model-id>`. Por exemplo, para GPT 5.5, você usaria `igris/gpt-5.5` na sua configuração.
