---
title: TUI
description: Usando a interface de usuário de terminal igris.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O igris fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar igris inicia o TUI para o diretório atual.
...
Ao usar o TUI do igris, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao igris. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do igris. _Aliases_: `/quit`, `/q`
...
Isso é separado do `igris.json`, que configura o comportamento do servidor/runtime.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `igris.default`.
