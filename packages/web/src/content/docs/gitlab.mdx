...
Here we are using a community-created CI/CD component for OpenCode — [nagyv/gitlab-igris](https://gitlab.com/nagyv/gitlab-igris).
...
For more inputs and use cases [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-igris) for this component.
...
Mention `@igris` in a comment, and OpenCode will execute tasks within your GitLab CI pipeline.
...
:::tip
You can configure to use a different trigger phrase than `@igris`.
:::
