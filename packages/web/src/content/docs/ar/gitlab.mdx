...
هنا نستخدم مكوّن CI/CD أنشأه المجتمع لـ OpenCode — [nagyv/gitlab-igris](https://gitlab.com/nagyv/gitlab-igris).
...
لمزيد من المُدخلات وحالات الاستخدام، [اطّلع على الوثائق](https://gitlab.com/explore/catalog/nagyv/gitlab-igris) الخاصة بهذا المكوّن.
...
اذكر `@igris` في تعليق، وسينفّذ OpenCode المهام ضمن خط أنابيب GitLab CI لديك.
...
:::tip
يمكنك ضبطه لاستخدام عبارة تشغيل مختلفة عن `@igris`.
:::
