...
أنشئ الملف `.igris/commands/test.md`:
...
- على مستوى النظام: `~/.config/igris/commands/`
- لكل مشروع: `.igris/commands/`
...
يتضمن igris عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).
