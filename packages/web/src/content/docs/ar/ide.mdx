...
يتكامل OpenCode مع VS Code و Cursor أو أي IDE يدعم terminal. ما عليك سوى تشغيل `igris` في terminal للبدء.
...
3. شغّل `igris` - سيتم تثبيت الامتداد تلقائيا
...
- تأكد من أنك تشغّل `igris` داخل terminal المدمجة.
