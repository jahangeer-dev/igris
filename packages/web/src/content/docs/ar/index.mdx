...
![واجهة OpenCode في terminal مع سمة igris](../../../assets/lander/screenshot.png)
...
- **باستخدام Homebrew على macOS وLinux**
  ...
  > نوصي باستخدام tap الخاص بـ OpenCode للحصول على أحدث الإصدارات. صيغة `brew install igris` الرسمية تُدار بواسطة فريق Homebrew ويتم تحديثها بوتيرة أقل.
...
يمكنك أيضا تنزيل الملف التنفيذي من صفحة [Releases](https://github.com/anomalyco/igris/releases).
...
1. شغّل الأمر `/connect` في واجهة TUI، واختر igris، ثم انتقل إلى [igris.ai/auth](https://igris.ai/auth).
...
إليك [مثالا لمحادثة](https://igris.ai/s/4XP1fce5) مع OpenCode.
