...
1. **Kør `igris web` i WSL-terminalen** i stedet for PowerShell:
...
Når du kører `igris web` fra WSL, får du korrekt filsystemadgang og terminalintegration, samtidig med at det stadig er tilgængeligt fra din Windows-browser.
...
- Din OpenCode-konfiguration og dine sessioner gemmes i WSL-miljøet i `~/.local/share/igris/`
