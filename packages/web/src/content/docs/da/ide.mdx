...
OpenCode integreres med VS Code, Cursor eller enhver IDE, der understøtter en terminal. Bare kør `igris` i terminalen for at komme i gang.
...
3. Kør `igris` - udvidelsen installeres automatisk
...
- Sørg for, at du kører `igris` i den integrerede terminal.
