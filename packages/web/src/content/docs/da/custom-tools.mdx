...
description: Opret værktøjer, som LLM kan kalde igris ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med igriss [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.igris/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/igris/tools/`.
