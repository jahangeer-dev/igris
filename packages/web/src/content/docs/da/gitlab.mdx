...
Her bruger vi en community-skabt CI/CD-komponent til OpenCode — [nagyv/gitlab-igris](https://gitlab.com/nagyv/gitlab-igris).
...
For flere input og use cases [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-igris) for denne komponent.
...
Nævn `@igris` i en kommentar, og OpenCode vil udføre opgaver i din GitLab CI-pipeline.
...
:::tip
Du kan konfigurere til at bruge en anden udløsersætning end `@igris`.
:::
