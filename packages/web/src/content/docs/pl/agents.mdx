...
Skonfiguruj agenta w pliku `igris.json`:
...
- Globalnie: `~/.config/igris/agents/`
- W projekcie: `.igris/agents/`
...
Identyfikator modelu jest taki sam, jak w konfiguracji OpenCode w `provider/model-id`. Na przykład, [OpenCode Zen](/docs/zen), użyj `igris/gpt-5.1-codex` dla GPT 5.1 Codex.
...
:::tip
Uruchom `igris models`, aby zobaczyć dostępne modele.
:::
...
:::tip
Masz agenta, którym warto się podzielić? [Prześlij PR](https://github.com/anomalyco/igris).
:::
