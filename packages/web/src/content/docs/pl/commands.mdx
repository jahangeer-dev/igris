...
Możesz zdefiniować polecenia w `igris.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji igris:
...
- Globalnie: `~/.config/igris/commands/`
- Na projekt: `.igris/commands/`
...
igris zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
