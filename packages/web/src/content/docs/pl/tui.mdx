---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala igris.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

igris zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie igris uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI igris, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do igris. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `igris.json`, który konfiguruje zachowanie serwera/runtime.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `igris.default`.
