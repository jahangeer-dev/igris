...
OpenCode integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `igris` in the terminal to get started.
...
3. Run `igris` - the extension installs automatically
...
- Ensure you’re running `igris` in the integrated terminal.
