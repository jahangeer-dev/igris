...
กำหนดค่าเอเจนต์ในไฟล์ `igris.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/igris/agents/`
- ระดับโปรเจ็กต์: `.igris/agents/`
...
:::tip
ใช้ `igris models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/anomalyco/igris)
:::
