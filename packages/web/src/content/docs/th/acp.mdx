...
ในการใช้ OpenCode ผ่าน ACP ให้กำหนดค่าโปรแกรมแก้ไขของคุณให้รันคำสั่ง `igris acp`
...
คุณสามารถใช้ CodeCompanion เพื่อใช้ igris เป็น ACP agent สำหรับแชท
...
igris ทำงานผ่าน ACP เหมือนกับใน terminal และรองรับฟีเจอร์ทั้งหมด:
