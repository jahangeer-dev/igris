...
- `.igris/plugins/` - Programtillegg på prosjektnivå
...
**npm-plugins** installeres automatisk ved hjelp av Bun ved oppstart. Pakker og deres avhengigheter er bufret i `~/.cache/igris/node_modules/`.
...
1. Global konfigurasjon (`~/.config/igris/igris.json`)
2. Prosjektkonfigurasjon (`igris.json`)
3. Global plugin-katalog (`~/.config/igris/plugins/`)
4. Prosjektpluginkatalog (`.igris/plugins/`)
...
Nivåer: `debug`, `info`, `warn`, `error`. Se [SDK dokumentasjon](https://igris.ai/docs/sdk) for detaljer.
