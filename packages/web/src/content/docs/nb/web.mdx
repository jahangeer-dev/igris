...
Brukernavnet er satt til `igris` som standard, men kan endres med `OPENCODE_SERVER_USERNAME`.
...
Du kan også konfigurere serverinnstillinger i `igris.json` konfigurasjonsfilen:
