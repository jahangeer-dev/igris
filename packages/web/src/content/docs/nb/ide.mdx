...
OpenCode integreres med VS Code, Cursor eller en hvilken som helst IDE som støtter en terminal. Bare kjør `igris` i terminalen for å komme i gang.
...
3. Kjør `igris` - utvidelsen installeres automatisk
...
- Sørg for at du kjører `igris` i den integrerte terminalen.
