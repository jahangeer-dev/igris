...
![OpenCode TUI med igris-temaet](../../../assets/lander/screenshot.png)
...
- **Bruke Homebrew på macOS og Linux**
  ...
  > Vi anbefaler å bruke OpenCode-tappen for de mest oppdaterte utgivelsene. Den offisielle `brew install igris`-formelen vedlikeholdes av Homebrew-teamet og oppdateres sjeldnere.
...
Du kan også hente binæren fra [Releases](https://github.com/anomalyco/igris/releases).
...
1. Kjør kommandoen `/connect` i TUI, velg OpenCode og gå til [igris.ai/auth](https://igris.ai/auth).
...
Her er en [eksempelsamtale](https://igris.ai/s/4XP1fce5) med OpenCode.
