...
igris søker etter disse stedene:

- Prosjektkonfigurasjon: `.igris/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/igris/skills/<name>/SKILL.md`
...
For prosjektlokale stier går igris opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.igris/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/igris/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.igris/skills/git-release/SKILL.md` slik:
...
igris viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `igris.json`:
...
**For innebygde agenter** (i `igris.json`):
