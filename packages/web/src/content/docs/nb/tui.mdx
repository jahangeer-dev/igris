---
title: TUI
description: Bruke igris-terminalbrukergrensesnittet.
---
...
Dette er atskilt fra `igris.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `igris.default`.
