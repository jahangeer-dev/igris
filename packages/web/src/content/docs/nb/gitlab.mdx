---
title: GitLab
description: Bruk igris i GitLab-problemer og Merge Requests.
---
...
Her bruker vi en fellesskapsskapt CI/CD-komponent for OpenCode — [nagyv/gitlab-igris](https://gitlab.com/nagyv/gitlab-igris).
...
For flere inndata og brukstilfeller [sjekk ut dokumentene](https://gitlab.com/explore/catalog/nagyv/gitlab-igris) for denne komponenten.
...
Nevn `@igris` i en kommentar, og OpenCode vil utføre oppgaver innenfor din GitLab CI-pipeline.
