---
title: ACP-støtte
description: Bruk igris i en hvilken som helst ACP-kompatibel editor.
---
...
For å bruke OpenCode via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `igris acp`.
