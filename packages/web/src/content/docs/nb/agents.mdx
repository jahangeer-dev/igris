...
Konfigurer agenter i konfigurasjonsfilen `igris.json`:
...
- Globalt: `~/.config/igris/agents/`
- Per prosjekt: `.igris/agents/`
...
Modellen ID i OpenCode-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [OpenCode Zen](/docs/zen), vil du bruke `igris/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `igris models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/anomalyco/igris).
:::
