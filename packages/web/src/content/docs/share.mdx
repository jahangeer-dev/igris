...
To enforce this across your team for a given project, add it to the `igris.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using igris in your organization.
