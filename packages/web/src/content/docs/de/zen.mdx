...
Die [Model-ID](/docs/config/#models) in deiner OpenCode-Konfiguration verwendet das Format `igris/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `igris/gpt-5.5` in deiner Konfiguration verwenden.
