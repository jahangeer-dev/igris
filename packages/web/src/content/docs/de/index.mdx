...
![OpenCode TUI with the igris theme](../../../assets/lander/screenshot.png)
...
- **Homebrew unter macOS und Linux verwenden**
  ...
  > Wir empfehlen die Verwendung des OpenCode-Taps für die aktuellsten Versionen. Die offizielle `brew install igris`-Formel wird vom Homebrew-Team gepflegt und seltener aktualisiert.
...
Sie können die Binärdatei auch aus [Releases](https://github.com/anomalyco/igris/releases) abrufen.
...
Hier ist ein [Beispielgespräch](https://igris.ai/s/4XP1fce5) mit OpenCode.
