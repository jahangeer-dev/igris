...
Hier verwenden wir eine von der Community erstellte CI/CD-Komponente für OpenCode – [nagyv/gitlab-igris](https://gitlab.com/nagyv/gitlab-igris).
...
Weitere Eingaben und Anwendungsfälle finden Sie unter [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-igris) für diese Komponente.
...
Erwähnen Sie `@igris` in einem Kommentar und OpenCode führt Aufgaben innerhalb Ihrer GitLab CI-Pipeline aus.
...
:::tip
Sie können die Verwendung einer anderen Triggerphrase als `@igris` konfigurieren.
:::
