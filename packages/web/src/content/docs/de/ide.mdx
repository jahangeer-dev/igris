...
OpenCode lässt sich in VS Code, Cursor oder jede IDE integrieren, die ein Terminal unterstützt. Führen Sie einfach `igris` im Terminal aus, um zu beginnen.
...
3. Führen Sie `igris` aus – die Erweiterung wird automatisch installiert
...
- Stellen Sie sicher, dass Sie `igris` im integrierten Terminal ausführen.
