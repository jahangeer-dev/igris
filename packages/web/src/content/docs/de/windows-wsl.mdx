...
1. **Fuehre `igris web` im WSL-Terminal aus**, nicht in PowerShell:
...
Wenn du `igris web` aus WSL startest, bleiben Dateizugriff und Terminal-Integration sauber.
...
- OpenCode-Konfiguration und Sitzungen liegen in WSL unter `~/.local/share/igris/`
