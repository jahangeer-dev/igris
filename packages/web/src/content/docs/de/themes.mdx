...
Standardmaessig verwendet OpenCode das `igris`-Theme.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/igris/themes/*.json` oder `$XDG_CONFIG_HOME/igris/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.igris/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.igris/themes/*.json`
