...
![OpenCode TUI con el tema igris](../../../assets/lander/screenshot.png)
...
- **Usando Homebrew en macOS y Linux**
  ...
  > Recomendamos utilizar el tap OpenCode para las versiones más actualizadas. La fórmula oficial `brew install igris` la mantiene el equipo Homebrew y se actualiza con menos frecuencia.
...
También puede obtener el binario desde [Versiones](https://github.com/anomalyco/igris/releases).
...
1. Ejecute el comando `/connect` en la TUI, seleccione igris y diríjase a [igris.ai/auth](https://igris.ai/auth).
...
Aquí tiene una [conversación de ejemplo](https://igris.ai/s/4XP1fce5) con OpenCode.
