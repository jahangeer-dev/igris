...
OpenCode se integra con VS Code, Cursor o cualquier IDE que admita un terminal. Simplemente ejecute `igris` en la terminal para comenzar.
...
3. Ejecute `igris`: la extensión se instala automáticamente
...
- Asegúrese de estar ejecutando `igris` en el terminal integrado.
