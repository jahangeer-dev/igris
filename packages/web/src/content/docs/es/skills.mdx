...
- Configuración del proyecto: `.igris/skills/<name>/SKILL.md`
- Configuración global: `~/.config/igris/skills/<name>/SKILL.md`
...
Carga cualquier `skills/*/SKILL.md` coincidente en `.igris/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/igris/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.igris/skills/git-release/SKILL.md` así:
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `igris.json`:
...
**Para agentes integrados** (en `igris.json`):
