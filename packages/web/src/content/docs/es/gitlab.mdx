...
Aquí estamos utilizando un componente CI/CD creado por la comunidad para OpenCode — [nagyv/gitlab-igris](https://gitlab.com/nagyv/gitlab-igris).
...
Para obtener más entradas y casos de uso, [consulte los documentos](https://gitlab.com/explore/catalog/nagyv/gitlab-igris) de este componente.
...
Mencione `@igris` en un comentario y OpenCode ejecutará tareas dentro de su canal de CI GitLab.
...
:::tip
Puede configurarlo para utilizar una frase de activación diferente a `@igris`.
:::
