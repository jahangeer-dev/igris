...
Esto es independiente de `igris.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `igris.default`.
