...
De forma predeterminada, OpenCode usa nuestro propio tema `igris`.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/igris/themes/*.json` o `$XDG_CONFIG_HOME/igris/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.igris/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.igris/themes/*.json`
