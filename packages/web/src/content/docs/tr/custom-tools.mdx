---
title: Özel Araçlar
description: LLM'un igris'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. igris'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.igris/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/igris/tools/` içine yerleştirerek.
