...
Ajan becerileri, igris'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
igris su konumlari tarar:

- Proje konfigurasyonu: `.igris/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/igris/skills/<name>/SKILL.md`
...
Proje yerel yollarinda igris, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.igris/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/igris/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.igris/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
igris, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`igris.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`igris.json` icinde):
