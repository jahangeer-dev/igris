...
LSP etkinleştirildiğinde ve igris bir dosyayı açtığında:
...
LSP sunucularını, igris yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
