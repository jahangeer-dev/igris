---
title: Paylasim
description: igris konusmalarini genel baglantilarla paylasin.
---

igris'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda igris:
...
igris, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak igris manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `igris.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda igris kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
