...
`.igris/commands/test.md` oluştur:
...
igris işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

igris [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/igris/commands/`
- Proje başına: `.igris/commands/`
...
igris, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
