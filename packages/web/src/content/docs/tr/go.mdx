...
OpenCode yapılandırmanızdaki [model id](/docs/config/#models) formatı `igris-go/<model-id>` şeklindedir. Örneğin, Kimi K3 için yapılandırmanızda `igris-go/kimi-k3` kullanmalısınız.
