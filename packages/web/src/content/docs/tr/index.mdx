...
![igris TUI with the igris theme](../../../assets/lander/screenshot.png)
...
- **Homebrew'u macOS ve Linux'ta kullanma**
  ...
  > En güncel sürümler için OpenCode tap'ini kullanmanızı öneririz. Resmi `brew install igris` formülü Homebrew ekibi tarafından korunur ve daha sık güncellenir.
...
İkili dosyayı [Releases](https://github.com/anomalyco/igris/releases)'dan da alabilirsiniz.
...
1. TUI'de `/connect` komutunu çalıştırın, OpenCode'u seçin ve [igris.ai/auth](https://igris.ai/auth)'ye gidin.
...
İşte OpenCode ile bir [örnek konuşma](https://igris.ai/s/4XP1fce5).
