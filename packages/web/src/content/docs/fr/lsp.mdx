...
Lorsque LSP est activé et qu'igris ouvre un fichier, il :
...
Vous pouvez activer et personnaliser les serveurs LSP via la section `lsp` de votre configuration igris.
