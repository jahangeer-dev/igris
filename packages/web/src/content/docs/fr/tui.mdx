...
Ceci est séparé de `igris.json`, qui configure le comportement du serveur/d'exécution.
...
- `sound_pack` - ID du sound pack à utiliser. Valeur par défaut : `igris.default`.
