...
Le [model id](/docs/config/#models) dans votre configuration OpenCode utilise le format `igris/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `igris/gpt-5.5` dans votre configuration.
