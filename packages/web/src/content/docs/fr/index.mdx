...
![OpenCode TUI avec le thème igris](../../../assets/lander/screenshot.png)
...
- **Via Homebrew sur macOS et Linux**
  ...
  > Nous vous recommandons d'utiliser le tap OpenCode pour les versions les plus récentes. La formule officielle `brew install igris` est maintenue par l'équipe Homebrew et est mise à jour moins fréquemment.
...
Vous pouvez également récupérer le binaire dans les [Releases](https://github.com/anomalyco/igris/releases).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez igris et allez sur [igris.ai/auth](https://igris.ai/auth).
...
Voici un [exemple de conversation](https://igris.ai/s/4XP1fce5) avec OpenCode.
