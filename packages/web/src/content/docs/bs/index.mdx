...
![OpenCode TUI sa igris temom](../../../assets/lander/screenshot.png)
Hajde da počnemo.
...
> Preporučujemo korištenje OpenCode tap za najnovija izdanja. Službenu formulu `brew install igris` održava Homebrew tim i ažurira se rjeđe.
...
Također možete preuzeti binarnu datoteku iz [Releases](https://github.com/anomalyco/igris/releases).
...
:::
Evo [primjer razgovora](https://igris.ai/s/4XP1fce5) sa OpenCode.
