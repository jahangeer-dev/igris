...
Ovdje koristimo CI/CD komponentu kreiranu u zajednici za OpenCode — [nagyv/gitlab-igris](https://gitlab.com/nagyv/gitlab-igris).
...
Za više unosa i slučajeva upotrebe [pogledajte dokumente docs](https://gitlab.com/explore/catalog/nagyv/gitlab-igris) za ovu komponentu.
...
Spomenite `@igris` u komentaru i OpenCode će izvršiti zadatke unutar vašeg GitLab CI cevovoda.
...
:::tip
Možete konfigurirati da koristite drugu frazu okidača od `@igris`.
:::
