...
- Konfiguracija projekta: `.igris/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/igris/skills/<name>/SKILL.md`
...
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.igris/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/igris/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.igris/skills/git-release/SKILL.md` ovako:
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `igris.json`:
...
**Za ugradene agente** (u `igris.json`):
