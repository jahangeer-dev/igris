...
OpenCode se integriše sa VS kodom, Cursor-om ili bilo kojim IDE-om koji podržava terminal. Samo pokrenite `igris` u terminalu da započnete.
...
3. Pokrenite `igris` - ekstenzija se automatski instalira
...
- Uvjerite se da koristite `igris` u integriranom terminalu.
