...
export const enterprise = "https://igris.ai/enterprise"
...
If a user enables the `/share` feature, the conversation and the data associated with it are sent to the service we use to host these share pages at igris.ai.
