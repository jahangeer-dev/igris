...
class Database extends Context.Service<Database, DatabaseShape>()("@igris/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@igris/example/UserStore") {
