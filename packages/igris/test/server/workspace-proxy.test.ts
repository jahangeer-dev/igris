...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips igris-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-igris-directory"]).toBeUndefined()
      expect(forwarded["x-igris-workspace"]).toBeUndefined()
