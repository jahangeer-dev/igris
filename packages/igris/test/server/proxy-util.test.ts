...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips igris-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-igris-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-igris-directory")).toBeNull()
      expect(result.get("x-igris-workspace")).toBeNull()
