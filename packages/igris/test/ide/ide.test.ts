...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders IGRIS_CALLER", () => {
    process.env["IGRIS_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode IGRIS_CALLER", () => {
    process.env["IGRIS_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown IGRIS_CALLER", () => {
    process.env["IGRIS_CALLER"] = "unknown"
