...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/igris.git")).toEqual({ owner: "sst", repo: "igris" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/igris")).toEqual({ owner: "sst", repo: "igris" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/igris.git")).toEqual({ owner: "sst", repo: "igris" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/igris")).toEqual({ owner: "sst", repo: "igris" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/igris.git")).toEqual({ owner: "sst", repo: "igris" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/igris")).toEqual({ owner: "sst", repo: "igris" })
})
