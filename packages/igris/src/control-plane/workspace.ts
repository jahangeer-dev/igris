...
import { EventSequenceTable, EventTable } from "@igris-ai/core/event/sql"
...
import { WorkspaceEvent } from "@igris-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@igris/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        IGRIS_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        IGRIS_WORKSPACE_ID: config.id,
        IGRIS_EXPERIMENTAL_WORKSPACES: "true",
