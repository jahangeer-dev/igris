...
import { ProjectDirectoryTable, ProjectTable } from "@igris-ai/core/project/sql"
import { ProjectDirectories } from "@igris-ai/core/project/directories"
...
import { which } from "@igris-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@igris/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.IGRIS_FAKE_VCS)
