...
import { llmClient } from "@igris-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@igris-ai/llm"
import { LLMClient } from "@igris-ai/llm/route"
import type { LLMClientService } from "@igris-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@igris/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via igris's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @igris-ai/llm. It
