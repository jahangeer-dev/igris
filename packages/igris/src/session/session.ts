...
import { locationServiceMapLayer } from "@igris-ai/core/location-services"
...
import { PartTable, SessionTable } from "@igris-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@igris-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".igris", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@igris/Session") {}
