...
import { buildPrompt } from "@igris-ai/core/session/compaction"
import { SessionCompactionEvent } from "@igris-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@igris/SessionCompaction") {}
