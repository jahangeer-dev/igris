import type { JsonSchema, LLMRequest, ProviderMetadata } from "@igris-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@igris-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @igris-ai/llm request objects from igris's session/AI SDK-shaped data.
  return LLM.request({
