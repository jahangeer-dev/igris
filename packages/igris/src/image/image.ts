...
export class Service extends Context.Service<Service, Interface>()("@igris/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __IGRIS_PHOTON_WASM_PATH?: string }).__IGRIS_PHOTON_WASM_PATH =
