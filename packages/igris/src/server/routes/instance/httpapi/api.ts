...
import { makeApi } from "@igris-ai/protocol/api"
import { LocationMiddleware } from "@igris-ai/server/location"
import { SessionLocationMiddleware } from "@igris-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("igris-root")
...
export const InstanceHttpApi = HttpApi.make("igris-instance")
...
export const OpenCodeHttpApi = HttpApi.make("igris")
