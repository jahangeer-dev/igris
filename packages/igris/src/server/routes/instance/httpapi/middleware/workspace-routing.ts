...
>()("@igris/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@igris/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.IGRIS_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.IGRIS_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-igris-directory"] || process.cwd()
}
