...
import type * as SDK from "@igris-ai/sdk/v2"
...
import { SessionShareTable } from "@igris-ai/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@igris/ShareNext") {}
