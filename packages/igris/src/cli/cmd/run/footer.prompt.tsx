...
import { normalizePromptContent } from "@igris-ai/tui/editor"
...
import { IGRIS_BASE_MODE, useBindings } from "@igris-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Igris" } satisfies SlashOption,
    ]
