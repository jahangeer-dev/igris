...
//
// The saved variant persists across sessions in ~/.local/state/igris/model.json
...
class Service extends Context.Service<Service, VariantService>()("@igris/RunVariant") {}
