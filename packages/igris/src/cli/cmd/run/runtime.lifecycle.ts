...
import { openEditor } from "@igris-ai/tui/editor"
import { registerIgrisKeymap } from "@igris-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerIgrisKeymap(keymap, renderer, input.tuiConfig)
