...
import type { Event, GlobalEvent, OpencodeClient } from "@igris-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@igris/RunStreamTransport") {}
