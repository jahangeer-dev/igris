...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@igris-ai/sdk/v2"
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to OPENCODE_SERVER_USERNAME or 'igris')",
      })
      .option("dir", {
        type: "string",
