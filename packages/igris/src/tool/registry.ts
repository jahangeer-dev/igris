...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@igris-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@igris/ToolRegistry") {}
