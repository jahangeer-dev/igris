...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@igris/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@igris/ACPDirectory") {}
