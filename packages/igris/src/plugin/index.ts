...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "igris-gitlab-auth"
import { PoeAuthPlugin } from "igris-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@igris/Plugin") {}
