...
Practical reference for the current tool-migration state in `packages/igris`.
...
Tool tests should use the existing Effect helpers in `packages/igris/test/lib/effect.ts`:
