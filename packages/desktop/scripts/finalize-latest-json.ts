...
const releaseId = process.env.IGRIS_RELEASE
if (!releaseId) throw new Error("IGRIS_RELEASE is required")

const version = process.env.IGRIS_VERSION
if (!version) throw new Error("IGRIS_VERSION is required")
...
const macxTarGz = "igris-desktop-mac-x64.app.tar.gz"
const macaTarGz = "igris-desktop-mac-arm64.app.tar.gz"
