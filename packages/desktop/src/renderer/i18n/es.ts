export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Igris",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Igris. ¿Quieres instalarla y reiniciar?",
