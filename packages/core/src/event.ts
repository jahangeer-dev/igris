...
import type { Data, Definition, Payload } from "@igris-ai/schema/event"
...
import { Durable } from "@igris-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@igris-ai/schema/event").ID
export type { Data, Definition, Payload } from "@igris-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@igris/Event") {}
