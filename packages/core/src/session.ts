...
import { ListAnchor } from "@igris-ai/schema/session"
...
import { SessionDurable } from "@igris-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@igris/v2/Session") {}
