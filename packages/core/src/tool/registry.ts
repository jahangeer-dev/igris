...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@igris-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@igris/v2/ToolRegistry") {}
