...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: "Server configuration for igris serve and web commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://igris.ai/docs/commands",
  }),
  ...
  model_tiers: Schema.optional(Schema.Record(Schema.String, Schema.String)).annotate({
    description: "Model tier mappings for agent routing (e.g. { \"cheap\": \"openai/gpt-4-mini\", \"ultra\": \"anthropic/claude-opus-4\" })",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://igris.ai/docs/agents" }),
