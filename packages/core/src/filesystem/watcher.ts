...
import { FileSystemWatcher } from "@igris-ai/schema/filesystem-watcher"
...
declare const IGRIS_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof IGRIS_LIBC === "undefined" ? undefined : IGRIS_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@igris/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.IGRIS_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.IGRIS_EXPERIMENTAL_FILEWATCHER)) {
