...
export class Service extends Context.Service<Service, Interface>()("@igris/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.IGRIS_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
