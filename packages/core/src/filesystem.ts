...
import { Entry, FileSystem, FindInput, Match } from "@igris-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@igris-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@igris/v2/FileSystem") {}
