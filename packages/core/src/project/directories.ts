...
import type { EffectDrizzleSqlite } from "@igris-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@igris/ProjectDirectories") {}
