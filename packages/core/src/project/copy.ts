...
import { Event } from "@igris-ai/schema/project-directories"
import { ProjectCopy } from "@igris-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@igris/ProjectCopy") {}
