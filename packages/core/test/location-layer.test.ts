...
import { define } from "@igris-ai/plugin/v2/effect"
...
import { LocationServiceMap } from "@igris-ai/core/location-services"
      ...
      Effect.flatMap(([blocked, allowed]) =>
        Effect.gen(function* () {
          ...
          yield* Effect.promise(() =>
            fs.writeFile(
              path.join(blocked.path, "igris.json"),
              JSON.stringify({
