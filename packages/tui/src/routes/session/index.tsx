...
import { IGRIS_BASE_MODE, useBindings, useCommandShortcut, useIgrisKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["igris", "igris-go"])
...
export function Session() {
  ...
  const sessionCommandList = createMemo(() => [
    ...
    {
      title: local.permission.skillSuggest ? "Disable skill suggestions" : "Enable skill suggestions",
      value: "session.skill-suggest",
      category: "Session",
      slash: {
        name: "skill-suggest",
      },
      run: () => {
        local.permission.toggleSkillSuggest()
        dialog.clear()
      },
    },
  ])
