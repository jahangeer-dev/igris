...
import defaultSoundPath from "@igris-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@igris-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@igris-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@igris-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@igris-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@igris-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "igris"
const DEFAULT_PACK_ID = "igris.default"
