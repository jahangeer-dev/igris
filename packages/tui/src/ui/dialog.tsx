...
import { useBindings, useIgrisModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useIgrisModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.IGRIS_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
