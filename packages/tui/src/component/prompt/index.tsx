...
import type { AssistantMessage, FilePart, UserMessage } from "@igris-ai/sdk/v2"
...
import { IGRIS_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useIgrisKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.IGRIS_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
