...
const tools: readonly ToolFixture[] = [
  ...
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/igris (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/igris/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/igris/src/index.ts [offset=1, limit=100]",
