...
declare const IGRIS_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof IGRIS_CLI_NAME === "string" ? IGRIS_CLI_NAME : "igris", {
  description: "Igris 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
