      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://igris.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>igris.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g igris-ai")}>
                <code>
                  npm i -g <strong>igris-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g igris-ai")}>
                <code>
                  bun add -g <strong>igris-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/igris")}>
                <code>
                  brew install <strong>anomalyco/tap/igris</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S igris")}>
                <code>
                  paru -S <strong>igris</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask igris-desktop")}>
                <code>
                  brew install --cask <strong>igris-desktop</strong>
                </code>
                <CopyStatus />
              </button>
