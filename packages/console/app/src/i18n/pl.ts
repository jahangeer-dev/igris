...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | igris",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo igris",
  "notFound.logoDarkAlt": "ciemne logo igris",
  ...
  "workspace.newUser.step.login.after": "i wybierz igris",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom igris i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług igris.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy igris",
