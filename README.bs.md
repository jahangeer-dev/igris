...
<p align="center">Igris je open source AI agent za programiranje.</p>
<p align="center">
...
Igris je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/anomalyco/igris/releases) ili sa [igris.ai/download](https://igris.ai/download).
...
1. `$IGRIS_INSTALL_DIR` - Prilagođeni instalacijski direktorij
...
Igris uključuje dva ugrađena agenta između kojih možeš prebacivati tasterom `Tab`.
...
Za više informacija o konfiguraciji Igris-a, [**pogledaj dokumentaciju**](https://igris.ai/docs).

### Doprinosi

Ako želiš doprinositi Igris-u, pročitaj [upute za doprinošenje](./CONTRIBUTING.md) prije slanja pull requesta.

### Gradnja na Igris-u

Ako radiš na projektu koji je povezan s Igris-om i koristi "igris" kao dio naziva, npr. "igris-dashboard" ili "igris-mobile", dodaj napomenu u svoj README da projekat nije napravio Igris tim i da nije povezan s nama.
