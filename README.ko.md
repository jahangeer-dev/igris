...
# 패키지 매니저
npm i -g igris-ai@latest        # bun/pnpm/yarn 도 가능
scoop install igris             # Windows
choco install igris             # Windows
brew install anomalyco/tap/igris # macOS 및 Linux (권장, 항상 최신)
brew install igris              # macOS 및 Linux (공식 brew formula, 업데이트 빈도 낮음)
sudo pacman -S igris            # Arch Linux (Stable)
paru -S igris-bin               # Arch Linux (Latest from AUR)
mise use -g igris               # 어떤 OS든
nix run nixpkgs#igris           # 또는 github:anomalyco/igris 로 최신 dev 브랜치
```
...
Igris 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/igris/releases) 에서 직접 다운로드하거나 [igris.ai/download](https://igris.ai/download) 를 이용하세요.
...
Igris 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://igris.ai/docs/agents) 에 대해 더 알아보세요.

### 문서

Igris 설정에 대한 자세한 내용은 [**문서**](https://igris.ai/docs) 를 참고하세요.

### 기여하기

Igris 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### Igris 기반으로 만들기

Igris 와 관련된 프로젝트를 진행하면서 이름에 "igris"(예: "igris-dashboard" 또는 "igris-mobile") 를 포함한다면, README 에 해당 프로젝트가 Igris 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.

---

**커뮤니티에 참여하기** [Discord](https://discord.gg/igris) | [X.com](https://x.com/igris)
